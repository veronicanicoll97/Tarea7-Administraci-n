...
router.get('/categoriaById/:idCategoria', (req, res) =>
    controller.categoriaPorId(req, res)
);
router.get('/categoriaById', (req, res) => controller.categoriaPorId(req, res));
router.delete('/eliminarCategoria/:idCategoria', (req, res) =>
    controller.eliminarCategoria(req, res)
);
router.delete('/eliminarCategoria', (req, res) =>
    controller.eliminarCategoria(req, res)
);
router.post('/crearCategoria', (req, res) =>
    controller.crearCategoria(req, res)
);
router.put('/actualizarCategoria', (req, res) =>
