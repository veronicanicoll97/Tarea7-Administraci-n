...
class CategoriaService {
    ...
    async categoriaPorId(log, idCategoria) {
        try {
            ...
            const categoria = 
                await this.#categoria.categoriaById(Number(idCategoria), log);
            return categoria;
        } catch (error) {
            log.error(JSON.stringify(error));
            throw error;              
    ...
    async eliminarCategoria(log, idCategoria) {
        try {
            ...
            const categoria = 
                await this.#categoria.eliminarCategoria(Number(idCategoria), log);
    ...
    async crearCategoria(log, datos) {
        try {
            ...
            const categoria = 
                await this.#categoria.crearCategoria(datos, log);
            return categoria;
        } catch (error) {
            log.error(JSON.stringify(error));
            throw error;              
